...
class MixupInteractor(nn.Module):
    def __init__(
        self,
        args,
        ...
        super(MixupInteractor, self).__init__()
        self.args = args
    ...
    def forward(
        ...
        for i in range(self.num_interaction_blocks):
            ...
            common_feature_map = mask.float() * x_2d + (1 - mask.float()) * x_3d

            x_2d = common_feature_map
            x_3d = common_feature_map
