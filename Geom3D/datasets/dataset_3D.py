...
if __name__ == "__main__":
    ...
    def extend_graph(data):
        ...
        value = edge_index.new_ones((edge_index.size(1),), dtype=torch.float)
        edge_index_2_hop, value_2_hop = spspmm(
            edge_index, value, edge_index, value, N, N, N
        )
        print("edge_index_2_hop", edge_index_2_hop)
        print("value_2_hop", value_2_hop)
        value_2_hop.fill_(1)
        edge_index_3_hop, value_3_hop = spspmm(
            edge_index, value, edge_index_2_hop, value_2_hop, N, N, N
        )
